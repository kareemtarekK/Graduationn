      ...
      <div className={styles.wrapper}>
        <div className={styles.formCard}>
          <div className={styles.header}>
            ...
            <p className={styles.subtitle}>
              Please provide all possible details to assist the relevant authorities in tracking the vehicle
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className={styles.form}>
            ...
            {/* Row 2: Plate Number + National ID */}
            <div className={styles.formRow}>
              <div className={styles.formGroup}>
            ...
            {/* Vehicle Specs - Full Width Textarea */}
            <div className={styles.formGroup}>
        ...
        <div className={styles.disclaimer}>
          {/* <div className={styles.disclaimerIcon}>
            {/* <svg xmlns="" className={styles.infoIcon} viewBox="0 0 20 20" fill="currentColor">
              <path
                fillRule="evenodd"
          ...
          <p className={styles.disclaimerText}>
           <span>ⓘ</span> The information provided on this form is confidential and is used only for investigative purposes. For more information, please contact <br />
